...
{#if href}
	<!-- eslint-disable svelte/no-navigation-without-resolve -- href may be internal or external -->
	<a
		bind:this={ref}
		data-slot="button"
		class={classes}
