...
import { decodeBase64, inspectPng } from "../src/assets/importer";

const transparentPixel = "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAC0lEQVR4nGNgAAIAAAUAAXpeqz8AAAAASUVORK5CYII=";

describe("PNG transport primitives", () => {
  it("decodes and identifies a valid PNG", () => {
    expect(inspectPng(decodeBase64(transparentPixel))).toEqual({ width: 1, height: 1 });
  });
